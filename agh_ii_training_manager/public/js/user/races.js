...
__WEBPACK_IMPORTED_MODULE_0_jquery__('.tbl-races tr').bind('click', function () {
    var id = __WEBPACK_IMPORTED_MODULE_0_jquery__(this).children()[0].innerHTML;
    var options = '';
    __WEBPACK_IMPORTED_MODULE_0_jquery__["getJSON"](window.location.origin + "/races/" + id, function (data) {
        for (var i = 0; i < data['heats'].length; i++) {
            var h = data['heats'][i];
        ...
        content.html("");
        var div = __WEBPACK_IMPORTED_MODULE_0_jquery__('<div id=race_details></div>');
        ...
        btn_join.on('click', function () {
            __WEBPACK_IMPORTED_MODULE_0_jquery__["ajax"]({
                ...
                data: {
                    customer_id: user.id,
                    race_id: id,
                    heat_id: __WEBPACK_IMPORTED_MODULE_0_jquery__('#heats').find('option:selected').val()
                },
                success: function success(response) {
                    if (response.success) Object(__WEBPACK_IMPORTED_MODULE_1__utils__["showMessage"])("Registration successful", 'green');else Object(__WEBPACK_IMPORTED_MODULE_1__utils__["showMessage"])(response.message);
                }
            });
            modal.toggle();
        });
