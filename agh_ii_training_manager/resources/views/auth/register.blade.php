                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{route('register')}}">
                        ...
                        <div class="form-group{{ $errors->has('second_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="second_name" type="text" class="form-control" name="second_name" value="{{ old('second_name') }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('zip-code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="zip-code" type="text" class="form-control" name="zip-code" value="{{ old('zip-code') }}" required autofocus>
